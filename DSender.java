...
public class DSender {
	...
	/**
	 * <b>DSender constructor</b> creates a DatagramPacket containing a String message,
	 * that is then sent to an IP address (String representation of the IP address)
	 * through a specific port.
	 * <p>
	 * <b>Note:</b> DatagramPacket delivery is not guaranteed.
	 * 
	 * @param mMessage The message to be sent to the server
	 * @param mInetAddressName The name of the host
	 * @param mPort The port the DatagramPacket is sent on
	 * @throws Exception  
	 */
